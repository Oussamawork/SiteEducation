        ...
        <div class="row">
            @foreach($posts as $post) 
                @if( $post->type_id === 1)
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="single-course mb-25">
                            <div class="course-content border border-primary mb-3">
                ...
                @if( $post->type_id === 2)
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="single-course mb-25">
                            <div class="course-content border border-success mb-3">
                ...
                @if( $post->type_id === 3)
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="single-course mb-25">
                            <div class="course-content border border-danger mb-3">
